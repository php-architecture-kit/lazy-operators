...
class DivisionOperatorSerializer implements ExpressionSerializer
{
    use DeserializesNarrowly;

    public function supports(Expression $expression): bool
    {
        return $expression instanceof DivisionOperator;
    }

    public function expressionVersion(): string
    {
        return DivisionOperator::VERSION;
    }
    ...
    {
        assert($expression instanceof DivisionOperator);

        return [
            'uid' => DivisionOperator::UID,
            'key' => DivisionOperator::KEY,
            'class' => DivisionOperator::class,
            'version' => DivisionOperator::VERSION,
            'args' => [
