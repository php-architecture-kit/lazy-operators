...
class AsinhFunctionSerializer implements ExpressionSerializer
{
    ...
    {
        assert($expression instanceof AsinhFunction);

        return [
            'uid' => AsinhFunction::UID,
            'key' => AsinhFunction::KEY,
            'class' => AsinhFunction::class,
            'version' => AsinhFunction::VERSION,
            'args' => [
