...
final class LogFunctionTest extends TestCase
{
    ...
    {
        $function = new LogFunction(new NumericSpyExpression(M_E));
    ...
    {
        $function = new LogFunction(new NumericSpyExpression(100.0), new NumericSpyExpression(10.0));
    ...
    {
        $function = new LogFunction(new NumericSpyExpression(0.0));
